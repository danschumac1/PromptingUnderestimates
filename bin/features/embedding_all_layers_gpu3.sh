#!/bin/bash
# 3708926 ( paste kill id here )
# chmod +x ./bin/features/embedding_all_layers_gpu3.sh
# ./bin/features/embedding_all_layers_gpu3.sh
# nohup ./bin/features/embedding_all_layers_gpu3.sh > ./logs/embedding_all_layers_gpu3.log 2>&1 &
# tail -f ./logs/embedding_all_layers_gpu3.log
