#!/bin/bash
# 1499432
# chmod +x ./bin/features/forecast_extract_features_2.sh
# ./bin/features/forecast_extract_features_2.sh
# nohup ./bin/features/forecast_extract_features_2.sh > ./logs/forecast_extract_2.log 2>&1 &
# tail -f ./logs/forecast_extract_2.log

LOG_FILE="./logs/forecast_extract_2.log"
mkdir -p ./logs
