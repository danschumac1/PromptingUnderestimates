...
# chmod +x ./bin/embedding_erfan_1.sh
# ./bin/embedding_erfan_1.sh
# nohup ./bin/embedding_erfan_1.sh > ./logs/embedding_erfan_1_master.log 2>&1 &
# tail -f ./logs/embedding_erfan_1_master.log

###############################################################################
# PING LOGIC
###############################################################################
LOG_FILE="./logs/embedding_erfan_1_master.log"
