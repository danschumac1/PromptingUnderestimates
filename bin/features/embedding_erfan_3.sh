...
# chmod +x ./bin/embedding_erfan_3.sh
# ./bin/embedding_erfan_3.sh
# nohup ./bin/embedding_erfan_3.sh > ./logs/embedding_erfan_3_master.log 2>&1 &
# tail -f ./logs/embedding_erfan_3_master.log

###############################################################################
# PING LOGIC
###############################################################################
LOG_FILE="./logs/embedding_erfan_3_master.log"
