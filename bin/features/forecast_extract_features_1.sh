#!/bin/bash
# 1579311
# chmod +x ./bin/features/forecast_extract_features_1.sh
# ./bin/features/forecast_extract_features_1.sh
# nohup ./bin/features/forecast_extract_features_1.sh > ./logs/forecast_extract_1.log 2>&1 &
# tail -f ./logs/forecast_extract_1.log

LOG_FILE="./logs/forecast_extract_1.log"
mkdir -p ./logs
