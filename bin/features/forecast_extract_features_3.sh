#!/bin/bash
# 1499432
# chmod +x ./bin/features/forecast_extract_features_3.sh
# ./bin/features/forecast_extract_features_3.sh
# nohup ./bin/features/forecast_extract_features_3.sh > ./logs/forecast_extract_3.log 2>&1 &
# tail -f ./logs/forecast_extract_3.log

LOG_FILE="./logs/forecast_extract_3.log"
mkdir -p ./logs
