#!/bin/bash
# 2406307 ( paste kill id here )
# chmod +x ./bin/embedding_gpu3.sh
# ./bin/embedding_gpu3.sh
# nohup ./bin/embedding_gpu3.sh > ./logs/embedding_gpu3_master.log 2>&1 &
# tail -f ./logs/embedding_gpu3_master.log

###############################################################################
# PING LOGIC
###############################################################################
LOG_FILE="./logs/embedding_gpu3_master.log"
