#!/bin/bash
# 1604875 ( paste kill id here )
# chmod +x ./bin/features/embedding_all_layers_gpu0.sh
# ./bin/features/embedding_all_layers_gpu0.sh
# nohup ./bin/features/embedding_all_layers_gpu0.sh > ./logs/embedding_all_layers_gpu0.log 2>&1 &
# tail -f ./logs/embedding_all_layers_gpu0.log
