#!/bin/bash
# 1856124 ( paste kill id here )
# chmod +x ./bin/features/embedding_all_layers_gpu2.sh
# ./bin/features/embedding_all_layers_gpu2.sh
# nohup ./bin/features/embedding_all_layers_gpu2.sh > ./logs/embedding_all_layers_gpu2.log 2>&1 &
# tail -f ./logs/embedding_all_layers_gpu2.log
