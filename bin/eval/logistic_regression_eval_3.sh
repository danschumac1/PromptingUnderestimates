...
# chmod +x ./bin/eval/logistic_regression_eval_3.sh
# ./bin/eval/logistic_regression_eval_3.sh
# nohup ./bin/eval/logistic_regression_eval_3.sh > ./logs/eval/logistic_regression_eval_3_master.log 2>&1 &
# tail -f ./logs/eval/logistic_regression_eval_3_master.log
