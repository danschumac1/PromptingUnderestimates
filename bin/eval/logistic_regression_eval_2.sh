#!/bin/bash
# 3846505 ( paste kill id here )
# chmod +x ./bin/eval/logistic_regression_eval_2.sh
# ./bin/eval/logistic_regression_eval_2.sh
# nohup ./bin/eval/logistic_regression_eval_2.sh > ./logs/eval/logistic_regression_eval_2_master.log 2>&1 &
# tail -f ./logs/eval/logistic_regression_eval_2_master.log
