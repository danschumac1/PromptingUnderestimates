#!/bin/bash
# 1700352
# chmod +x ./bin/generation/forecast_prompting_3.sh
# Usage: ./bin/generation/forecast_prompting_3.sh
# Run background: nohup ./bin/generation/forecast_prompting_3.sh > ./logs/forecast_prompting_3.log 2>&1 &
# Monitor: tail -f ./logs/forecast_prompting_3.log

LOG_FILE="./logs/forecast_prompting_3.log"
mkdir -p ./logs
