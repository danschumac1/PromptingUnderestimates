#!/bin/bash
# 2260019
# chmod +x ./bin/generation/pass_at_k_4.sh
# ./bin/generation/pass_at_k_4.sh
# nohup ./bin/generation/pass_at_k_4.sh > ./logs/pass_at_k_4_master.log 2>&1 &
# tail -f ./logs/pass_at_k_4_master.log
