#!/bin/bash
# 2748453
# chmod +x ./bin/generation/pass_at_k_1.sh
# ./bin/generation/pass_at_k_1.sh
# nohup ./bin/generation/pass_at_k_1.sh > ./logs/pass_at_k_1_master.log 2>&1 &
# tail -f ./logs/pass_at_k_1_master.log
