#!/bin/bash
# 2749697
# chmod +x ./bin/generation/pass_at_k_3.sh
# ./bin/generation/pass_at_k_3.sh
# nohup ./bin/generation/pass_at_k_3.sh > ./logs/pass_at_k_3_master.log 2>&1 &
# tail -f ./logs/pass_at_k_3_master.log
