#!/bin/bash
# 2206589 ( paste kill id here )
# chmod +x ./bin/generation/prompting_gpu3.sh
# ./bin/generation/prompting_gpu3.sh
# nohup ./bin/generation/prompting_gpu3.sh > ./logs/prompting_gpu3_master.log 2>&1 &
# tail -f ./logs/prompting_gpu3_master.log

LOG_FILE="./logs/prompting_gpu3_master.log"
