#!/bin/bash
# 2700205
# chmod +x ./bin/generation/variant_prompting_2.sh
# ./bin/generation/variant_prompting_2.sh
# nohup ./bin/generation/variant_prompting_2.sh > ./logs/variant_prompting_2_master.log 2>&1 &
# tail -f ./logs/variant_prompting_2_master.log

LOG_FILE="./logs/variant_prompting_2_master.log"
