...
# chmod +x ./bin/prompting_erfan_3.sh
# ./bin/prompting_erfan_3.sh
# nohup ./bin/prompting_erfan_3.sh > ./logs/prompting_erfan_3_master.log 2>&1 &
# tail -f ./logs/prompting_erfan_3_master.log

LOG_FILE="./logs/prompting_erfan_3_master.log"
