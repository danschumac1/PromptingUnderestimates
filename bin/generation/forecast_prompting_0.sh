#!/bin/bash
# 1679670
# chmod +x ./bin/generation/forecast_prompting_0.sh
# Usage: ./bin/generation/forecast_prompting_0.sh
# Run background: nohup ./bin/generation/forecast_prompting_0.sh > ./logs/forecast_prompting_0.log 2>&1 &
# Monitor: tail -f ./logs/forecast_prompting_0.log

LOG_FILE="./logs/forecast_prompting_0.log"
mkdir -p ./logs
