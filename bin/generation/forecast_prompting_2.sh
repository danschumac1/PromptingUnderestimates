#!/bin/bash
# 1699599
# chmod +x ./bin/generation/forecast_prompting_2.sh
# Usage: ./bin/generation/forecast_prompting_2.sh
# Run background: nohup ./bin/generation/forecast_prompting_2.sh > ./logs/forecast_prompting_2.log 2>&1 &
# Monitor: tail -f ./logs/forecast_prompting_2.log

LOG_FILE="./logs/forecast_prompting_2.log"
mkdir -p ./logs
