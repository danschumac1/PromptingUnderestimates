#!/bin/bash
# 4092585
# chmod +x ./bin/generation/logistic_regression_2.sh
# ./bin/generation/logistic_regression_2.sh
# nohup ./bin/generation/logistic_regression_2.sh > ./logs/logistic_regression_2.log &
# tail -f ./logs/logistic_regression_2.log
###############################################################################
# set -Eeuo pipefail
# set -o errtrace
...
# SLACK TRAPS
###############################################################################
LOG_FILE="./logs/logistic_regression_2.log"
